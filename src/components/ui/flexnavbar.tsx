...
const FlexNavbar: React.FC<FlexNavbarProps> = ({
  ...
  // --- NEW: Helper function to handle scrolling to top ---
      ...
      >
        ...
        >
          <div className={cn("flex justify-between items-center relative")}>
            ...
            {/* --- UPDATED SECTION: Brand Name is now a clickable button --- */}
            <button
              onClick={handleScrollToTop}
              className={cn(
                "absolute left-1/2 -translate-x-1/2 font-medium tracking-tight text-black dark:text-white cursor-pointer hover:opacity-80 transition-opacity"
              )}
